...
float vWisps(vec2 uv,float topF){
  ...
  float d=clamp(uWispDensity,0.0,2.0);
...
export const LaserFlow: React.FC<Props> = ({
    ...
    useEffect(() => {
        ...
        const onMove = (ev: PointerEvent) => {
            ...
            const hb = rect.height * baseDpr;
            mouseTarget.set(x * baseDpr, hb - y * baseDpr);
        };
    ...
    }, [dpr, color, wispDensity, mouseSmoothTime, mouseTiltStrength, horizontalBeamOffset, verticalBeamOffset, flowSpeed, verticalSizing, horizontalSizing, fogIntensity, fogScale, wispSpeed, wispIntensity, flowStrength, decay, falloffStart, fogFallSpeed]);
